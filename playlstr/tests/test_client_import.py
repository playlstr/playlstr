...
class ClientLinkTestCase(TestCase):
    ...
    def test_linking_client_invalid(self):
        client_id = ''.join(random.choice(string.ascii_lowercase + string.digits) for i in range(20))
        # Invalid link code
    ...
    def test_linking_client(self):
        ...
        self.assertIn(client_id, self.user.linked_clients, 'Link valid client id and link code')
